...
def main():
    ...
    parser.add_argument("--source", "-s", 
                       default="examples/image_pairs/fire_academy_0.png",
                       help="Path to source image")
    parser.add_argument("--target", "-t",
                       default="examples/image_pairs/fire_academy_1.png", 
                       help="Path to target image")
    parser.add_argument("--model", choices=["base", "refine"], default="base",
                       help="Model variant to use")
    parser.add_argument("--output", "-o", default="ufm_output.png",
